    ...
    Self: Clone + Default + Debug + for<'de> Deserialize<'de> + Serialize + Sized,
{
    ...
    /// sent over the [`WebSocket`](rustrade_integration::protocol::websocket::WebSocket). Implements
    ...
    /// [`WebSocket`](rustrade_integration::protocol::websocket::WebSocket) pings for the exchange
...
/// [`InstrumentKind`](rustrade_instrument::instrument::kind::InstrumentKind) market data on distinct servers,
...
/// [`WebSocket`](rustrade_integration::protocol::websocket::WebSocket) pings - used for exchanges
